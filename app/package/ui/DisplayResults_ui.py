...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.bg_img_label.sizePolicy().hasHeightForWidth())
        self.bg_img_label.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.spectrum_groupBox.sizePolicy().hasHeightForWidth())
        self.spectrum_groupBox.setSizePolicy(sizePolicy2)
